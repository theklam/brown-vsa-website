...
$lang_rate_pic = array(
	'rate_this_pic' => 'Βαθμολογήστε αυτήν την φωτογραφία ',
...
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array(
	'alb_need_name' => 'Τα άλμπουμ πρέπει να έχουν όνομα !',
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
	...
	array('Διαδρομή για την εφαρμογή ImageMagick \'convert\' (παράδειγμα /usr/bin/X11/)', 'impath', 0),
	...
	array('Κωδικοποίηση χαρακτήρων', 'charset', 4),
...
$lang_display_image_php = array(
	'confirm_del' => 'Είστε σίγουρος πως θέλετε να ΔΙΑΓΡΑΨΕΤΕ αυτή την φωτογραφία ? \\nΤα Σχόλια επίσης θα διαγραφούν.',
...
if (defined('EDITPICS_PHP')) $lang_editpics_php = array(
	'pic_info' => 'Πληροφορίες&nbsp;φωτογραφίας',
	'album' => 'Aλμπουμ',
	'title' => 'Tίτλος',
	'desc' => 'Περιγραφή',
	'keywords' => 'Λέξεις κλειδιά',
...
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array(
	'already_rated' => 'Συγνώμη αλλά έχετε ήδη βαθμολογήσει αυτή την φωτογραφία',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
	'page_title' => 'Αναζήτηση νέων φωτογραφιών',
	...
	'target_album' => '<b>Εισαγωγή φωτογραφιών &quot;</b>%s<b>&quot; στο </b>%s',
	'folder' => 'Κατάλογος',
	'image' => 'Εικόνα',
	'album' => 'Aλμπουμ',
	'result' => 'Αποτέλεσμα',
	...
	'notes' =>  '<ul>'.
				'<li><b>OK</b> : σημαίνει πως η φωτογραφία εισήχθει επιτυχώς'.
				'<li><b>DP</b> : σημαίνει πως η φωτογραφία υπάρχει ήδη στην βάση δεδομένων'.
				'<li><b>PB</b> : σημαίνει πως η φωτογραφία δεν μπορεί να προστεθεί, ελένξτε τις ρυθμίσεις σας και αν έχετε άδεια να χρησιμοποιήσετε τους καταλόγους που βρίσκονται οι φωτογραφίες'.
				'<li>Εαν τα OK, DP, PB \'signs\' δεν εμφανίζονται, επιλέξτε πάνω στην μη εμφανιθείσα εικόνα τους να δείτε τι πρόβλημα παρουσιάστηκε από την γλώσσα PHP'.
