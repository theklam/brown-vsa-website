...
if (defined('CONFIG_PHP')) $lang_config_data = array(
    ...
    array('Použi rozmer ( šírka alebo výška alebo maximálny rozmer náh¾adu )<b>*</b>', 'thumb_use', 7),
    array('Vytvori stredný obrázok','make_intermediate',1),
    array('Maximálna šírka alebo výška stredného obrázku <b>*</b>', 'picture_width', 0),
    ...
    array('Adresár pre galérie užívate¾ov <b>*</b>', 'userpics', 0),
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
    ...
    'note1' => '<b>(1)</b> Upload do verejných galérií vyžaduje potvrdenie adminom',
    'note2' => '<b>(2)</b> Upload do galérie patriacej užívate¾ovi vyžaduje potvrdenie adminom',
    'notes' => 'Poznámky'
);
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
    ...
    'target_album' => '<b>Vloži obrázky z &quot;</b>%s<b>&quot; do </b>%s',
    'folder' => 'Zložka',
    'image' => 'Obrázok',
    'album' => 'Galéria',
    'result' => 'Výsledok',
    ...
    'notes' =>  '<ul>'.
                ...
                '<li><b>DP</b> : Zdvojenie!, Tento obrázok už existuje'.
                '<li><b>PB</b> : tento obrázok nemožno prida, skontrolujte konfiguráciu prípadne prístupové práva'.
