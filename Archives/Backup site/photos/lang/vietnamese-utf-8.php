...
'trans_name'=> 'Hữu Từ', //the name of the translator
...
$lang_errors = array(
        'access_denied' => 'Bạn không có quyền ở trang này',
...
$lang_main_menu = array(
        'alb_list_title' => 'Danh sách Album',
...
$lang_album_list = array(
        'album_on_page' => '%d album trên %d trang'
);
...
$lang_img_nav_bar = array(
        'thumb_title' => 'trở lại trang thumbnail',
...
$lang_rate_pic = array(
        'rate_this_pic' => 'Đánh giá hình này ',
...
if (defined('ADMIN_PHP')) $lang_admin_php = array(
        0 => 'Thoát khỏi giao diện Quản trị....',
...
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array(
        'alb_need_name' => 'Cần đặt tên cho Album',
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
        ...
        array('Địa chỉ hiển thị trong thiệp', 'ecards_more_pic_target', 0),
        ...
        array('Chế độ mặc định cho đừơng dẫn', 'default_dir_mode', 0),
        array('Chế độ mặc định cho hình ', 'default_file_mode', 0),

        'Cookies &amp; Charset ',
        array('Tên của cookie', 'cookie_name', 0),
        array('Đừơng dẫn của cookie', 'cookie_path', 0),
        array('Kiểu mã hoá ký tự (charset)', 'charset', 4),
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
        'empty_name_or_com' => 'Bạn cần viết tên và lời nhận xét vào',
...
$lang_display_image_php = array(
        'confirm_del' => 'Có chắc chắn xóa hình này kô ? \\nNhận xét cũng sẽ bí xoá',
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
        'title' => 'Gửi an e-card',
        'invalid_email' => '<b>Cảnh báo</b> : địa chỉ mail không hợp lý !',
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
        ...
        'note1' => '<b>(1)</b> đựơc tải hỉnh lên chỗ cần đựơc Ban Quản Trị đồng ý ',
        'note2' => '<b>(2)</b> đựơc upload lên nơi mà user cần Ban Quản Tri cho phép',
        'notes' => 'Ghi chú'
);
...
$lang_album_admin_menu = array(
        'confirm_delete' => 'Có chắc là bạn muốn xóa Album này  ? \\n Tất cả hình và nhận xét cũng sẽ bị xoá.',
        'delete' => 'XÓA',
        'modify' => 'THUỘC TÍNH',
        'edit_pics' => 'SỬA HÌNH',
);
...
$lang_list_categories = array(
        'home' => 'Trang chủ',
        'stat1' => '<b>[pictures] </b> hình trong <b>[albums]</b> album và <b>[cat]</b> Phân loại với <b>[comments]</b> nhận xét, xem <b>[views]</b> lần',
        'stat2' => '<b>[pictures]</b> hình trong <b>[albums]</b> album đựơc xem <b>[views]</b> lần',
        'xx_s_gallery' => 'hình của %s\ ',
        'stat3' => '<b>[pictures]</b> hình trong <b>[albums]</b> album với <b>[comments]</b> nhận xét, đựơc xem <b>[views]</b> lần'
);

$lang_list_users = array(
        'user_list' => 'Danh sách ngừơi dùng',
...
if (defined('LOGIN_PHP')) $lang_login_php = array(
        'login' => 'Đăng nhập',
        'enter_login_pswd' => 'Điền tên và mật khẩu của bạn vào',
        'username' => 'Tên',
        'password' => 'Mật khẩu',
        'remember_me' => 'Nhớ mật khẩu cho lần sau đăng nhập',
        'welcome' => 'Chào mừng %s ...',
        'err_login' => '*** Không thể đăng nhập. Thử lại xem nào ***',
        'err_already_logged_in' => 'Bạn đã đăng nhập rồi!',
);
...
if (defined('LOGOUT_PHP')) $lang_logout_php = array(
        'logout' => 'Thoát',
        'bye' => 'tạm biệt %s ...',
        'err_not_loged_in' => 'bạn chưa đăng nhập !',
);
...
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array(
        'already_rated' => 'Xin lỗi, bạn đã đánh giá hình này 1 lần rồi',
...
$lang_register_php = array(
        'page_title' => 'Đăng ký làm thành viên',
        'term_cond' => 'Nội qui',
        'i_agree' => 'tôi đồng ý',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
        ...
        'target_album' => '<b>Đặt hình của  &quot;</b>%s<b>&quot; vào </b>%s',
        'folder' => 'Thư mục',
        'image' => 'Hình',
        'album' => 'Album',
        'result' => 'Kết quả',
        ...
        'notes' =>  '<ul>'.
                                '<li><b>OK</b> : hình đã đựơc thêm vào'.
                                '<li><b>DP</b> : hình này trùng lặp và đã có trong cơ sở dữ liệu'.
                                '<li><b>PB</b> : hình của bạn không thể đựơc thêm vào, kiểm tra lại cấu hình hoặc quyền.'.
                                '<li>Nếu OK, DP, PB \'signs\' không xuất hiện thì click vào hình để PHP thông báo lỗi gặp phải'.
                                '<li>Nếu web bị đứng, bấm F5 hoặc refresh'.
                                '</ul>',
);
