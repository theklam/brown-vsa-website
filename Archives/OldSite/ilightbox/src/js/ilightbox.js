	...
	iLightBox.prototype = {
		...
		addContents: function() {
			var iL = this,
				...
				recognizingItems = (opts.smartRecognition && vars.total > 0) && iL.items || iL.items.filter(function(e, i, arr) {
					return ['image', 'flash', 'video'].indexOf(e.type) === -1 && typeof e.recognized === 'undefined' && e.options.smartRecognition;
				}),
